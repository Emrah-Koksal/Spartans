...
public class SpartansAPISteps {
    ...
    @When("User checks and asserts API replies using the Spartan with the ID of {int}")
    public void user_checks_and_asserts_api_replies_using_the_spartan_with_the_id_of(Integer int1) {
...
public void user_checks_and_asserts_api_replies_using_de_serialization_map_method_of_a_spartan_with_the_id_of_and_name(Integer int1, String featureExpectedName) {
    ...
    public void user_checks_and_asserts_api_replies_using_gson_of_a_spartan_with_the_id_of(Integer int1) {
        ...
        Spartans_POJO spartanMeta= gson.fromJson(json,Spartans_POJO.class);
